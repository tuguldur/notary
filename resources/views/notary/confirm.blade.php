    ...
    <div class="card">
      ...
      <p>Нотариатын үйл ажиллагааг /цахимаар/ эрхлэх зөвшөөрлийг хуульд заасан журмын дагуу зохион байгуулсан мэргэшлийн шалгалтад тэнцсэн баримтаа 
        ...
        <div class="row">
            ...
            <p>-Таны баримтын овог, нэр, регистрийн дугаар бүртгэлийн мэдээллээс зөрсөн тохиолдолд бүртгэл баталгаажих боломжгүйг анхаарна уу. Та цахим бүртгэлдээ засвар оруулахыг хүсвэл хүсвэл <a href="/profile">бүртгэл</a> хуудсаар зочилно уу.</p>   
            <p>-Та баримтаа явуулсны дараа хариу гартал баримтаа дахин илгээх боломжгүй юм.</p>
            <p>-Таны бүртгэлийн төрөл үйлчлүүлэгч байвал буцаж энэ төрөлөө авах боломжгүйг анхаарна уу.</p>
        </div>
