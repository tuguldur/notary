...
@section('title', 'Хэрэглэгч бүртгүүлэх')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <h5 class="title text-center">Бүртгүүлэх</h5>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Цахим хаяг') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="registration_number" class="col-md-4 col-form-label text-md-right">{{ __('Регистрийн дугаар') }}</label>
